...
```{r}
require(gbm)
boost.boston=gbm(medv~.,data=Boston[train,],distribution="guassian",n.trees=10000,shrinkage=0.01,interaction.depth=4) #normally these parameters would need some tuning/testing
