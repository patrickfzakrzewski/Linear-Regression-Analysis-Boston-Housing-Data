...
Splines
-------
Spliens rae more flexible than polynomials, but the idea is rather similar.
...
abline(v==c(25,4060),lty=2,col="darkgreen")
```

The smoothign splines do not require knot selection, but ut does have a smoothing parameter,
...
One nice feature of the `gam` package is that it knows to plot the functions nicely,
